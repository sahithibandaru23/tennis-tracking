...
def main():
    ...
    ball_tracker = BallTracker(model_path="https://github.com/your-username/your-repo/blob/main/models/yolo5_last.pt")
    court_line_detector = CourtLineDetector("https://github.com/your-username/your-repo/blob/main/models/keypoints_model.pth")
